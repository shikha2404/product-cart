        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute">
            <div class="container">
                <div class="navbar-wrapper">
                    <a class="navbar-brand" href="#pablo"> E-Cart LOGIN </a>
             ...
             <div class="content">
                <div class="container">
                    <div class="col-md-6 col-sm-6 ml-auto mr-auto">
                        <form class="form" method="post" action="{{url('sign-up-new-user')}}" >
                            @csrf
                            <div class="card card-login card-hidden">
                                <div class="card-header ">
                                    <h3 class="header text-center"> Sign Up to Begin !</h3>
                                </div>
                                ...
                                <div class="card-footer ml-auto mr-auto">
                                    <button type="submit" class="btn btn-warning btn-wd"> Submit </button>
                                </div>
                              <div class="col mb-2">    
                              <p> Already Registered ? <a href="{{url('sign-in')}}" > Login </a> </p>
                              </div>
                            </div>
                        </form>
                    </div>
